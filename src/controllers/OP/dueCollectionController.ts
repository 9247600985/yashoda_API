...
export default class dueCollectionController {
 ...
 async getAllDueBillByConsultation(req: Request, res: Response) {
    ...
    const sqlText = `
        SELECT 
            b.BILLTYPE, b.BILLDATE, b.BILLNO, 
            b.TOTALBILLAMT, b.TOTDISCOUNT, b.AMOUNTPAID, 
            b.RFNDAMOUNT,
            (b.TOTALBILLAMT - b.TOTDISCOUNT - b.AMOUNTPAID - b.RFNDAMOUNT - ISNULL(b.AMOUNTRCVD,0)) AS Due,
            b.MEDRECNO,
            b.AGE,
            b.SEX,
            b.DEPTCODE,
            ...
            b.PATCATG,
            b.OPDREGNO,
            (SELECT patient_name FROM Patient_Master WHERE PatientMr_No = b.MEDRECNO) AS PATNAME
        FROM OPD_BILLMST b
        WHERE b.MEDRECNO = @MRNO 
            AND (b.TOTALBILLAMT - b.TOTDISCOUNT - b.AMOUNTPAID - b.RFNDAMOUNT - ISNULL(b.AMOUNTRCVD,0)) > 0 
        ORDER BY b.BILLTYPE, b.BILLDATE
    `;
    ...
    try {
        ...
        const rows = data.records.map((r: any) => ({
            ...
            BILLNO:       r.BILLNO    || "",
            BILLTYPE:     r.BILLTYPE  || "",
            TOTALBILLAMT: parseFloat(r.TOTALBILLAMT  ?? 0).toFixed(2),
            TOTDISCOUNT:  parseFloat(r.TOTDISCOUNT   ?? 0).toFixed(2),
            AMOUNTPAID:   parseFloat(r.AMOUNTPAID    ?? 0).toFixed(2),
            RFNDAMOUNT:   parseFloat(r.RFNDAMOUNT    ?? 0).toFixed(2),
            DUEAMOUNT:    parseFloat(r.Due           ?? 0).toFixed(2),
            MEDRECNO:     r.MEDRECNO  || "",
            PATNAME:      r.PATNAME   || "",
            AGE:          r.AGE       || "",
            SEX:          r.SEX       || "",
